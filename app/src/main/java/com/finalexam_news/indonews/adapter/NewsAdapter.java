package com.finalexam_news.indonews.adapter;
...
import com.finalexam_news.indonews.holder.NewsViewHolder;
import com.finalexam_news.indonews.model.ModelNews;
import com.finalexam_news.indonews.utils.TimeUnits;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsViewHolder> {
    ...
    public NewsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.list_item_news, viewGroup, false);
